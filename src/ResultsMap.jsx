...
const ResultsMap = () => {
  ...
  const handleMarkerClick = (location, marker) => {
    ...
    //   `${hit.address_1},${hit.city},${hit.state},${hit.zip_code}`
    // );
    // const directionsUrl = `https://www.google.com/maps/dir/?api=1&destination=${encodedAddress}`;
    // const contentString = `<div id="content">
    //   <ul class="info-window__items">
    //     <li class="info-window__title"><h4>${hit.name}</h4></li>
    //     <li>${hit.primary_specialty}</li>
    //     <li>${hit.address_1}, <span class="info-window__address-info">${
    //   hit.city
    // }, ${hit.state}, ${hit.zip_code}</span></li>
    //     ${hit.address_2 ? `<li>${hit.address_2}</li>` : ""}
    //     ${hit.phone ? `<li>${hit.phone}</li>` : ""}
    //     <li><a href=${directionsUrl} target="_blank">Directions</a>
    //   </ul>
    // </div>`;
  ...
  const createCluster = (instance, markers) => {};
